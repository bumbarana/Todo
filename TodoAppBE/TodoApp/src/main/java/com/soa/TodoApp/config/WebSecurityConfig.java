package com.soa.TodoApp.config;



import com.soa.TodoApp.security.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable().authorizeRequests()
                .antMatchers(  HttpMethod.GET,"/addTodo")
                .permitAll()
                .antMatchers(  HttpMethod.GET,"/removeTodo/{id}")
                .permitAll()
                .antMatchers(  HttpMethod.GET,"/getTodos/{id}")
                .permitAll()
                //.anyRequest().hasAnyAuthority("TEACHER", "USER")
